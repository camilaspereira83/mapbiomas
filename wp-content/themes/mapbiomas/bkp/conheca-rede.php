    ...
    <div class="container">
        <div class="row  justify-content-center">
            <div class="col-xl-9" data-aos="fade-left">
                ...
                <?php
                    $page_title = ( $has_acf ? get_field( 'page_title', 'option' ) : '' );
                    $page_subtitle = ( $has_acf ? get_field( 'page_subtitle', 'option' ) : '' );
                ?>
                <?php if ( $page_title ) : ?>
            ...
            <div class="col-xl-9">
                ...
                <div class="comm-grid">
                    ...
                    <div class="comm-member">
                        ...
                        <?php endif; ?>
                        <div class="comm-name"><?php echo esc_html( $m['name'] ); ?></div>
            ...
            <div class="col-12">
                ...
                <div class="funders-pills">
                    <?php foreach ( $funders as $f ) :
                        ...
                        if ( ! $name ) continue;
                    ?>
                    <span class="funders-pill"><?php echo esc_html( $name ); ?></span>
                    <?php endforeach; ?>
                </div>
            </div>
        </div>
