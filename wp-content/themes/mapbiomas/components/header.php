        ...
        <div class="header__inner">
            ...
            <div class="header__language">
                <button type="button" class="language-current active" aria-expanded="false">
                    ...
                    <img class="language-flag" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/BR.svg'); ?>" alt="Ícone da bandeira do Brasil" width="12" height="12" />
                ...
                <ul class="language-list">
                    <li class="language-item">
                        <button type="button" class="language-option">
                            ...
                            <img class="language-flag" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/AR.svg'); ?>" alt="Ícone da bandeira do Argentina" width="12" height="12" />
                        </button>
                    </li>
                    <li class="language-item">
                        <button type="button" class="language-option">
                            <span class="language-label">BO</span>
                            <img class="language-flag" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/BO.svg'); ?>" alt="Ícone da bandeira do Bolivia" width="12" height="12" />
                        </button>
                    </li>
                </ul>
            </div>
