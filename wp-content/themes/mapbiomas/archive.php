...
$news_banner_title   = ($has_acf ? get_field('news_banner_title',   'option') : '') ?: 'Notícias';
$news_filter_label   = ($has_acf ? get_field('news_filter_label',   'option') : '') ?: 'Filtrar por:';
$news_filter_all     = ($has_acf ? get_field('news_filter_all',     'option') : '') ?: 'Todas';
$news_filter_country = ($has_acf ? get_field('news_filter_country', 'option') : '') ?: 'País';
$news_filter_theme   = ($has_acf ? get_field('news_filter_theme',   'option') : '') ?: 'Tema';
$news_events_title   = ($has_acf ? get_field('news_events_title',   'option') : '') ?: 'Próximos Eventos';
?>
<?php get_header(); ?>
    ...
    <div class="container">
        <div class="row  justify-content-center">
            <div class="col-xl-9" data-aos="fade-left">
                ...
                <h1 class="title"><?php echo esc_html($news_banner_title); ?></h1>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-xl-9" data-aos="fade-up">
                <div class="news__filter">
                    <form method="GET" class="filters">
                        <a href="<?php echo remove_query_arg(['pais', 'tema']); ?>" class="filter-btn"><?php echo esc_html($news_filter_all); ?></a>
                        <p><?php echo esc_html($news_filter_label); ?></p>
                        <div class="filter-select">
                            <select name="pais" onchange="this.form.submit()">
                                <option value=""><?php echo esc_html($news_filter_country); ?></option>
                        ...
                        <div class="filter-select">
                            <select name="tema" onchange="this.form.submit()">
                                <option value=""><?php echo esc_html($news_filter_theme); ?></option>
...
<section class="events">
    <div class="container">
        <div class="row  justify-content-center">
            <div class="col-xl-9" data-aos="fade-up">
                <h4><?php echo esc_html($news_events_title); ?></h4>
